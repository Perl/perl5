...

{
    ...
    is( scalar @warnings, 0, "Warnings are disabled by default pre 5.33" );

    # This *should* result in a warning
    eval { use v5.033; my $foo; "This doesn't need to be here...".$foo; };
    is( scalar @warnings, 1, "Warnings are enabled by default post 5.33" );
}
