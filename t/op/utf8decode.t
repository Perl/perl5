...
my @MK = split(/\n/, <<__EOMK__);
1	Correct UTF-8
1.1.1 y "Îºá½¹ÏƒÎ¼Îµ"	-		11	ce:ba:e1:bd:b9:cf:83:ce:bc:ce:b5	5
...
3.3.3 n "ð€€"		-	3	f0:80:80	-	3 bytes, need 4
3.3.4 n "ø€€€"		-	4	f8:80:80:80	-	4 bytes, need 5
3.3.5 n "ü€€€€"	-	5	fc:80:80:80:80	-	5 bytes, need 6
3.3.6 n "ß"			-	1	df	-	1 byte, need 2
3.3.7 n "ï¿"			-	2	ef:bf	-	2 bytes, need 3
...
3.5.3 n "þþÿÿ"			-	4	fe:fe:ff:ff	-	byte 0xfe
4	Overlong sequences
4.1	Examples of an overlong ASCII character
4.1.1 n "À¯"			-	2	c0:af	-	2 bytes, need 1
4.1.2 n "à€¯"		-	3	e0:80:af	-	3 bytes, need 1
4.1.3 n "ð€€¯"		-	4	f0:80:80:af	-	4 bytes, need 1
4.1.4 n "ø€€€¯"	-	5	f8:80:80:80:af	-	5 bytes, need 1
4.1.5 n "ü€€€€¯"	-	6	fc:80:80:80:80:af	-	6 bytes, need 1
4.2	Maximum overlong sequences
4.2.1 n "Á¿"			-	2	c1:bf	-	2 bytes, need 1
4.2.2 n "àŸ¿"		-	3	e0:9f:bf	-	3 bytes, need 2
4.2.3 n "ð¿¿"		-	4	f0:8f:bf:bf	-	4 bytes, need 3
4.2.4 n "ø‡¿¿¿"		-	5	f8:87:bf:bf:bf	-	5 bytes, need 4
4.2.5 n "üƒ¿¿¿¿"		-	6	fc:83:bf:bf:bf:bf	-	6 bytes, need 5
4.3	Overlong representation of the NUL character
4.3.1 n "À€"			-	2	c0:80	-	2 bytes, need 1
4.3.2 n "à€€"		-	3	e0:80:80	-	3 bytes, need 1
4.3.3 n "ð€€€"		-	4	f0:80:80:80	-	4 bytes, need 1
4.3.4 n "ø€€€€"	-	5	f8:80:80:80:80	-	5 bytes, need 1
4.3.5 n "ü€€€€€"	-	6	fc:80:80:80:80:80	-	6 bytes, need 1
5	Illegal code positions
5.1	Single UTF-16 surrogates
5.1.1 n "í €"		-	3	ed:a0:80	-	UTF-16 surrogate 0xd800
5.1.2 n "í­¿"			-	3	ed:ad:bf	-	UTF-16 surrogate 0xdb7f
5.1.3 n "í®€"		-	3	ed:ae:80	-	UTF-16 surrogate 0xdb80
5.1.4 n "í¯¿"			-	3	ed:af:bf	-	UTF-16 surrogate 0xdbff
5.1.5 n "í°€"		-	3	ed:b0:80	-	UTF-16 surrogate 0xdc00
5.1.6 n "í¾€"		-	3	ed:be:80	-	UTF-16 surrogate 0xdf80
5.1.7 n "í¿¿"			-	3	ed:bf:bf	-	UTF-16 surrogate 0xdfff
5.2	Paired UTF-16 surrogates
5.2.1 n "í €í°€"		-	6	ed:a0:80:ed:b0:80	-	UTF-16 surrogate 0xd800
5.2.2 n "í €í¿¿"		-	6	ed:a0:80:ed:bf:bf	-	UTF-16 surrogate 0xd800
5.2.3 n "í­¿í°€"		-	6	ed:ad:bf:ed:b0:80	-	UTF-16 surrogate 0xdb7f
5.2.4 n "í­¿í¿¿"		-	6	ed:ad:bf:ed:bf:bf	-	UTF-16 surrogate 0xdb7f
5.2.5 n "í®€í°€"		-	6	ed:ae:80:ed:b0:80	-	UTF-16 surrogate 0xdb80
5.2.6 n "í®€í¿¿"		-	6	ed:ae:80:ed:bf:bf	-	UTF-16 surrogate 0xdb80
5.2.7 n "í¯¿í°€"		-	6	ed:af:bf:ed:b0:80	-	UTF-16 surrogate 0xdbff
5.2.8 n "í¯¿í¿¿"		-	6	ed:af:bf:ed:bf:bf	-	UTF-16 surrogate 0xdbff
5.3	Other illegal code positions
5.3.1 n "ï¿¾"			-	3	ef:bf:be	-	byte order mark 0xfffe
# The ffff is illegal unless UTF8_ALLOW_FFFF
5.3.2 n "ï¿¿"			-	3	ef:bf:bf	-	character 0xffff
__EOMK__
