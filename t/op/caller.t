...
# NB : extend the warning mask values below when new warnings are added
{
    ...
    use warnings;
    BEGIN { check_bits( ${^WARNING_BITS}, "\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\025", 'default bits on via "use warnings"' ); }
    BEGIN { testwarn("\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\025", 'all'); }
    # run-time :
    # the warning mask has been extended by warnings::register
    testwarn("\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55", 'ahead of w::r');
    use warnings::register;
    BEGIN { check_bits( ${^WARNING_BITS}, "\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55", 'warning bits on via "use warnings::register"' ) }
    testwarn("\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55",'following w::r');
}
