...
my @tests = (
    ...
    '(?a)[[:alpha:]]' => 'POSIXA1R[:alpha:]',
    '(?a)[[:^alpha:]]' => 'NPOSIXA1R[:alpha:]',
    '(?a)[[:^alpha:]\x{2C2}]' => 'NPOSIXA1R[:alpha:]',
    '[[:alpha:][:^alpha:]]' => 'SANY',
    '[^[:alpha:][:^alpha:]]' => 'OPFAIL',
    '(?l)[[:alpha:][:^alpha:]]' => 'SANY',
    ...
    '(?a)[[:graph:]]' => 'POSIXA1R[:graph:]',
    '(?a)[[:^graph:]]' => 'NPOSIXA1R[:graph:]',
    '(?a)[[:^graph:]\x{FFFF}]' => 'NPOSIXA1R[:graph:]',
    '[[:graph:][:^graph:]]' => 'SANY',
    '[^[:graph:][:^graph:]]' => 'OPFAIL',
    '(?l)[[:graph:][:^graph:]]' => 'SANY',
    ...
    '(?a)[[:lower:]]' => 'POSIXA1R[:lower:]',
    '(?a)[[:^lower:]]' => 'NPOSIXA1R[:lower:]',
    '(?a)[[:^lower:]\x{2C2}]' => 'NPOSIXA1R[:lower:]',
    '[[:lower:][:^lower:]]' => 'SANY',
    '[^[:lower:][:^lower:]]' => 'OPFAIL',
    '(?l)[[:lower:][:^lower:]]' => 'SANY',
    ...
    '(?a)[[:print:]]' => 'POSIXA1R[:print:]',
    '(?a)[[:^print:]]' => 'NPOSIXA1R[:print:]',
    '(?a)[[:^print:]\x{FFFF}]' => 'NPOSIXA1R[:print:]',
    '[[:print:][:^print:]]' => 'SANY',
    '[^[:print:][:^print:]]' => 'OPFAIL',
    '(?l)[[:print:][:^print:]]' => 'SANY',
    ...
    '(?a)[[:upper:]]' => 'POSIXA1R[:upper:]',
    '(?a)[[:^upper:]]' => 'NPOSIXA1R[:upper:]',
    '(?a)[[:^upper:]\x{2C2}]' => 'NPOSIXA1R[:upper:]',
    '[[:upper:][:^upper:]]' => 'SANY',
    '[^[:upper:][:^upper:]]' => 'OPFAIL',
    '(?l)[[:upper:][:^upper:]]' => 'SANY',
    ...
    '(?i)(?a)[[:lower:]]' => 'POSIXA1R[:alpha:]',
    '(?i)(?a)[[:^lower:]]' => 'NPOSIXA1R[:alpha:]',
    '(?i)(?a)[[:^lower:]\x{2C2}]' => 'NPOSIXA1R[:alpha:]',
    ...
    '(?i)(?a)[[:upper:]]' => 'POSIXA1R[:alpha:]',
    '(?i)(?a)[[:^upper:]]' => 'NPOSIXA1R[:alpha:]',
    '(?i)(?a)[[:^upper:]\x{2C2}]' => 'NPOSIXA1R[:alpha:]',
    '(?i)[\d\w]' => 'POSIXD[\w]',
    '(?i)[\D\w]' => 'SANY',
