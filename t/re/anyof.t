...
BEGIN {
    ...
    skip_all('Not bothering to change these tests for this commit, as the next one will change them again');
...
my @tests = (
    ...
    '[\x{103}\x{102}]' => 'EXACTFU_ONLY8 <\x{103}>',
    ...
    '[{HIGHEST_CP}]' => 'EXACT_ONLY8 <\x{HIGHEST_CP}>',

    '(?8)(?i)[\x{410}]' => 'EXACTFU_ONLY8 <\x{430}>',
    '(?8)(?i)[\x{399}]' => 'EXACTFU_ONLY8 <\x{3b9}>',
    '(?8)(?i)[\x{345}\x{399}\x{3B9}\x{1FBE}]' => 'EXACTFU_ONLY8 <\x{3b9}>',
    '(?i)[\x{2b9}]' => 'EXACT_ONLY8 <\x{2b9}>',           # Doesn't participate in a fold
    ...
    '(?8)(?i)b[\x{100}]' => 'EXACTFU_ONLY8 <b\x{101}>',
    '(?i)b[s]' => 'EXACTFU <bs>',
    '(?i)b[s]c' => 'EXACTFU <bsc>',
