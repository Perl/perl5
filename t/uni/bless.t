...
{
    # The presence of 'local' in many of the tests below suggests that what
    # was originally being tested was global variables, subsequently
    # localized.  Hence, relax strictures for most of this file.
