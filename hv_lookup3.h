 ...
 * need adjustment.
 */
#include <stdint.h>     /* defines U32 etc */
...
S_perl_hash_lookup3_hashlittle(const unsigned char * const seed, const unsigned char *key, STRLEN length) 
{
  U32 a,b,c;                                          /* internal state */
  U32 const initval= *((U32*)seed);
