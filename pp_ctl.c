            ...
            for (
                ...
                if (SvROK(dirsv)) {
                    ...
                    if (sv_isobject(loader)) {
                         ...
                         * call the method. Otherwise assume its a blessed coderef.
                         */
                    ...
                    if (count > 0) {
                        ...
                        if (is_incdir) {
                            ...
                            /* We copy $SIG into incdir_continue_inc_idx
                             ...
                             * hook. We honour $SIG here just like we would for
                    ...
                    /*
                     ...
                     next by setting $SIG to a different value than it
