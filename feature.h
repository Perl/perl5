...
#define FEATURE_FIVE_BIT                 0x0040
...
#define FEATURE_FIVE_IS_ENABLED \
    ( \
	CURRENT_FEATURE_BUNDLE <= FEATURE_BUNDLE_527 \
     || (CURRENT_FEATURE_BUNDLE == FEATURE_BUNDLE_CUSTOM && \
	 FEATURE_IS_ENABLED_MASK(FEATURE_FIVE_BIT)) \
    )
...
S_magic_sethint_feature(pTHX_ SV *keysv, const char *keypv, STRLEN keylen,
    ...
    if (memBEGINs(keypv, keylen, "feature_")) {
        ...
        case 'f':
            ...
            else if (keylen == sizeof("feature_five")-1
                 && memcmp(subf+1, "ive", keylen - sizeof("feature_")) == 0) {
                mask = FEATURE_FIVE_BIT;
                break;
            }
            return;
