...
PERL_CALLCONV PP(pp_equ) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_i_equ) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_i_neu) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_i_postdec) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_i_postinc) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_multiparam) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_neu) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_paramstore) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_paramtest) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_sequ) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_sneu) __attribute__visibility__("hidden");
