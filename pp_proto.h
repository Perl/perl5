...
PERL_CALLCONV OP *Perl_pp_f_add(pTHX);
PERL_CALLCONV OP *Perl_pp_f_divide(pTHX);
PERL_CALLCONV OP *Perl_pp_f_multiply(pTHX);
PERL_CALLCONV OP *Perl_pp_f_subtract(pTHX);
