...
#define PL_rcurstack		(vTHX->Ircurstack)
...
#define PL_rmarkstack		(vTHX->Irmarkstack)
#define PL_rmarkstack_max	(vTHX->Irmarkstack_max)
#define PL_rmarkstack_ptr	(vTHX->Irmarkstack_ptr)
#define PL_rpeepp		(vTHX->Irpeepp)
#define PL_rs			(vTHX->Irs)
#define PL_rstack_base		(vTHX->Irstack_base)
#define PL_rstack_max		(vTHX->Irstack_max)
#define PL_rstack_sp		(vTHX->Irstack_sp)
