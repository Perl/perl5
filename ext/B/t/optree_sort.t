...
3  <0> pushmark s
4  <#> gv[*a] s
5  <1> rv2av[t4] lK/STRICT,1
6  <@> sort lK
7  <0> pushmark s
8  <#> gv[*a] s
9  <1> rv2av[t2] lKRM*/STRICT,1
...
# 3  <0> pushmark s
# 4  <$> gv(*a) s
# 5  <1> rv2av[t2] lK/STRICT,1
# 6  <@> sort lK
# 7  <0> pushmark s
# 8  <$> gv(*a) s
# 9  <1> rv2av[t1] lKRM*/STRICT,1
...
3  <0> pushmark s
4  <#> gv[*a] s
5  <1> rv2av[t4] lKRM*/STRICT,1
6  <@> sort lK/INPLACE
7  <;> nextstate(main -438 optree.t:288) v:*,&,$
8  <0> pushmark s
9  <#> gv[*a] s
a  <1> rv2av[t7] lK/STRICT,1
b  <@> reverse[t8] K/1
...
# 3  <0> pushmark s
# 4  <$> gv(*a) s
# 5  <1> rv2av[t2] lKRM*/STRICT,1
# 6  <@> sort lK/INPLACE
# 7  <;> nextstate(main 66 optree.t:346) v:*,&,$
# 8  <0> pushmark s
# 9  <$> gv(*a) s
# a  <1> rv2av[t4] lK/STRICT,1
# b  <@> reverse[t5] K/1
# c  <1> leavesub[1 ref] K/REFC,1
EONT_EONT
