...
# -        <1> rv2av[t4] vK/OURINTR,STRICT,1 ->3
# -           <#> gv[*y] s ->-
...
# 2        <0> padav[@x:634,636] vM/LVINTRO ->3
# -        <;> ex-nextstate(main 1594 optree_misc.t:27) v:*,&,$ ->3
# -        <1> rv2av[t3] vK/OURINTR,STRICT,1 ->3
# -           <$> gv(*y) s ->-
...
print $fh "no warnings;our \$a; our \@b;format =\n@<<<\n\$a\n@>>>\n\@b\n.";
close $fh;
...
# -           <1> ex-list lK ->8
# 5              <0> pushmark s ->6
# 7              <1> rv2av[t3] lKRM*/STRICT,1 ->8
# 6                 <#> gv[*a] s ->7
# 9        <;> nextstate(main 2 -e:1) v:*,&,{,$ ->a
# e        <2> aassign[t6] KS/COM_RC1 ->f
# -           <1> ex-list lK ->d
# a              <0> pushmark s ->b
# c              <1> rv2av[t5] lK/STRICT,1 ->d
# b                 <#> gv[*a] s ->c
# -           <1> ex-list lKPRM* ->e
