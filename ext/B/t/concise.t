...
SKIP: {
	...
	for my $style (@styles) {
	    is ( $combos{"$style/$mode"},
		 $combos{"$mode/$style"},
		 "results for my $style/$mode vs $mode/$style are the same" );
	}
    }
