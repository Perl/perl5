...
{
    PERL_ARGS_ASSERT_PERL_COPFILEGV_SET;
    CopFILEGV_set(c, gv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SVREFCNT_DEC_SET_NULL;
...
{
    PERL_ARGS_ASSERT_PERL_C9STRICT_UTF8_TO_UV;
    return c9strict_utf8_to_uv(s, e, cp_p, advance_p);
}

bool
Perl_do_aexec(pTHX_ NULLOK SV *really, NN SV **mark, NN SV **sp)
{
    PERL_ARGS_ASSERT_PERL_DO_AEXEC;
...
{
    PERL_ARGS_ASSERT_PERL_EXTENDED_UTF8_TO_UV;
...
{
    PERL_ARGS_ASSERT_PERL_FOLDEQ_UTF8;
...
{
    PERL_ARGS_ASSERT_PERL_GV_AVADD;
    return gv_AVadd(gv);
}
...
{
    PERL_ARGS_ASSERT_PERL_GV_HVADD;
    return gv_HVadd(gv);
}
...
{
    PERL_ARGS_ASSERT_PERL_GV_IOADD;
    return gv_IOadd(gv);
}
...
{
    PERL_ARGS_ASSERT_PERL_GV_SVADD;
    return gv_SVadd(gv);
}
...
{
    PERL_ARGS_ASSERT_PERL_GV_EFULLNAME3;
...
{
    PERL_ARGS_ASSERT_PERL_GV_FETCHMETH;
...
{
    PERL_ARGS_ASSERT_PERL_GV_FETCHMETH_AUTOLOAD;
...
{
    PERL_ARGS_ASSERT_PERL_GV_FETCHMETHOD;
...
{
    PERL_ARGS_ASSERT_PERL_GV_FULLNAME3;
...
{
    PERL_ARGS_ASSERT_PERL_HV_DELETE;
...
{
    PERL_ARGS_ASSERT_PERL_HV_DELETE_ENT;
...
{
    PERL_ARGS_ASSERT_PERL_HV_EXISTS;
...
{
    PERL_ARGS_ASSERT_PERL_HV_EXISTS_ENT;
...
{
    PERL_ARGS_ASSERT_PERL_HV_FETCH;
...
{
    PERL_ARGS_ASSERT_PERL_HV_FETCH_ENT;
...
{
    PERL_ARGS_ASSERT_PERL_HV_ITERNEXT;
...
{
    PERL_ARGS_ASSERT_PERL_HV_MAGIC;
    hv_magic(hv, gv, how);
}
...
{
    PERL_ARGS_ASSERT_PERL_HV_STORE;
...
{
    PERL_ARGS_ASSERT_PERL_HV_STORE_ENT;
...
{
    PERL_ARGS_ASSERT_PERL_HV_STORE_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_HV_STORES;
    return hv_stores(hv, key, val);
}

void
Perl_hv_undef(pTHX_ HV *hv)
{
    PERL_ARGS_ASSERT_PERL_HV_UNDEF;
    hv_undef(hv);
}
...
{
    PERL_ARGS_ASSERT_PERL_IBCMP_LOCALE;
...
{
    PERL_ARGS_ASSERT_PERL_IBCMP_UTF8;
...
{
    PERL_ARGS_ASSERT_PERL_IS_C9STRICT_UTF8_STRING;
...
{
    PERL_ARGS_ASSERT_PERL_IS_C9STRICT_UTF8_STRING_LOC;
...
{
    PERL_ARGS_ASSERT_PERL_IS_STRICT_UTF8_STRING;
...
{
    PERL_ARGS_ASSERT_PERL_IS_STRICT_UTF8_STRING_LOC;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_CHAR_BUF;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_FIXED_WIDTH_BUF_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_FIXED_WIDTH_BUF_LOC_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_STRING;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_STRING_LOC;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_STRING_LOC_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_IS_UTF8_VALID_PARTIAL_CHAR;
...
Perl_my_lstat(pTHX_ )
{
    PERL_ARGS_ASSERT_PERL_MY_LSTAT;
    return my_lstat();
}
...
{
    PERL_ARGS_ASSERT_PERL_NEWATTRSUB;
...
{
    PERL_ARGS_ASSERT_PERL_NEWAV_ALLOC_X;
...
{
    PERL_ARGS_ASSERT_PERL_NEWAV_ALLOC_XZ;
    return newAV_alloc_xz(size);
}

AV *
Perl_newAV_mortal(pTHX_ )
{
    PERL_ARGS_ASSERT_PERL_NEWAV_MORTAL;
    return newAV_mortal();
}
...
{
    PERL_ARGS_ASSERT_PERL_NEWGVGEN;
...
{
    PERL_ARGS_ASSERT_PERL_NEWSVSV_NOMG;
...
{
    PERL_ARGS_ASSERT_PERL_OP_LVALUE;
...
{
    PERL_ARGS_ASSERT_PERL_PHASE_NAME;
    return phase_name(perl_phase);
}

void
Perl_resume_compcv_and_save(pTHX_ struct suspended_compcv *buffer)
{
    PERL_ARGS_ASSERT_PERL_RESUME_COMPCV_AND_SAVE;
...
{
    PERL_ARGS_ASSERT_PERL_RESUME_COMPCV_FINAL;
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_AELEM;
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_FREEOP;
    save_freeop(o);
}
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_FREEPV;
    save_freepv(pv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_FREESV;
    save_freesv(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_HELEM;
...
{
    PERL_ARGS_ASSERT_PERL_SAVE_MORTALIZESV;
    save_mortalizesv(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_STRICT_UTF8_TO_UV;
...
{
    PERL_ARGS_ASSERT_PERL_SV_2BOOL;
    return sv_2bool(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_2PV_NOLEN;
...
{
    PERL_ARGS_ASSERT_PERL_SV_2PVBYTE;
...
{
    PERL_ARGS_ASSERT_PERL_SV_2PVBYTE_NOLEN;
...
{
    PERL_ARGS_ASSERT_PERL_SV_2PVUTF8;
...
{
    PERL_ARGS_ASSERT_PERL_SV_2PVUTF8_NOLEN;
...
{
    PERL_ARGS_ASSERT_PERL_SV_CATPVN;
...
{
    PERL_ARGS_ASSERT_PERL_SV_CATPVN_MG;
...
{
    PERL_ARGS_ASSERT_PERL_SV_CATSV;
    sv_catsv(dsv, sstr);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_CATSV_MG;
...
{
    PERL_ARGS_ASSERT_PERL_SV_COLLXFRM;
...
{
    PERL_ARGS_ASSERT_PERL_SV_COPYPV;
    sv_copypv(dsv, ssv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_COPYPV_NOMG;
...
{
    PERL_ARGS_ASSERT_PERL_SV_FORCE_NORMAL;
    sv_force_normal(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_INSERT;
...
{
    PERL_ARGS_ASSERT_PERL_SV_MORTALCOPY;
...
{
    PERL_ARGS_ASSERT_PERL_SV_NUMEQ;
...
{
    PERL_ARGS_ASSERT_PERL_SV_PVBYTE;
    return sv_pvbyte(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_PVN_FORCE;
...
{
    PERL_ARGS_ASSERT_PERL_SV_PVUTF8;
    return sv_pvutf8(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_SETSV;
    sv_setsv(dsv, ssv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_STREQ;
...
{
    PERL_ARGS_ASSERT_PERL_SV_TAINT;
    sv_taint(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_UNREF;
    sv_unref(sv);
}
...
{
    PERL_ARGS_ASSERT_PERL_SV_USEPVN;
...
{
    PERL_ARGS_ASSERT_PERL_SV_USEPVN_MG;
...
{
    PERL_ARGS_ASSERT_PERL_SV_UTF8_DOWNGRADE;
...
{
    PERL_ARGS_ASSERT_PERL_SV_UTF8_DOWNGRADE_NOMG;
...
{
    PERL_ARGS_ASSERT_PERL_SV_UTF8_UPGRADE;
...
{
    PERL_ARGS_ASSERT_PERL_SV_UTF8_UPGRADE_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_SV_UTF8_UPGRADE_NOMG;
...
{
    PERL_ARGS_ASSERT_PERL_TO_UNI_FOLD;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_HOP_BACK;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_HOP_FORWARD;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_HOP_SAFE;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_TO_UV;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_TO_UV_ERRORS;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8_TO_UV_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8N_TO_UVCHR;
...
{
    PERL_ARGS_ASSERT_PERL_UTF8N_TO_UVCHR_ERROR;
...
{
    PERL_ARGS_ASSERT_PERL_UV_TO_UTF8_MSGS;
...
{
    PERL_ARGS_ASSERT_PERL_UVCHR_TO_UTF8;
...
{
    PERL_ARGS_ASSERT_PERL_UVCHR_TO_UTF8_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_UVCHR_TO_UTF8_FLAGS_MSGS;
...
{
    PERL_ARGS_ASSERT_PERL_UVOFFUNI_TO_UTF8_FLAGS;
...
{
    PERL_ARGS_ASSERT_PERL_VALID_UTF8_TO_UVCHR;
...
{
    PERL_ARGS_ASSERT_PERL_WHICHSIG;
    return whichsig(sig);
}
