 ...
 * functions by that name.  All Unixes I know of support them, thus they are
 * not checked by the configuration script, but are directly defined here.
*/
 ...
 * should use the routine my_binmode(FILE *fp, char iotype) to
 * insure that a file is in "binary" mode -- that is, that no
 * translation of bytes occurs on read or write operations.
 */
#undef USEMYBINMODE
...
/* UNLINK_ALL_VERSIONS: This symbol, if defined, indicates that the
 * program should arrange to remove all versions of a file if
 * unlink() is called.  This is probably only relevant for VMS.
 */
/* #define UNLINK_ALL_VERSIONS / * */

/* VMS: This symbol, if defined, indicates that the program is running
 * under VMS.  It is currently automatically set by cpps running under
 * VMS, and is included here for completeness only.
 */
/* #define VMS / * */
