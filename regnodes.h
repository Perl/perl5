...
#define	EXACTF                	40	/* 0x28 Match this string using /id rules (w/len); (string not UTF-8, not guaranteed to be folded). */
#define	EXACTFL               	41	/* 0x29 Match this string using /il rules (w/len); (string not guaranteed to be folded). */
#define	EXACTFU               	42	/* 0x2a Match this string using /iu rules (w/len); (string folded iff in UTF-8; non-UTF8 folded length <= unfolded). */
#define	EXACTFAA              	43	/* 0x2b Match this string using /iaa rules (w/len) (string folded iff in UTF-8; non-UTF8 folded length <= unfolded). */
#define	EXACTFUP              	44	/* 0x2c Match this string using /iu rules (w/len); (string not UTF-8, not guaranteed to be folded; and its Problematic). */
#define	EXACTFLU8             	45	/* 0x2d Like EXACTFU, but use /il, UTF-8, folded, and everything in it is above 255. */
#define	EXACTFAA_NO_TRIE      	46	/* 0x2e Match this string using /iaa rules (w/len) (string not UTF-8, not guaranteed to be folded, not currently trie-able). */
...
#else
EXTCONST U8 PL_varies_bitmask[] = {
    0x00, 0x00, 0x00, 0x00, 0x30, 0x00, 0xF0, 0x87, 0xFF, 0x65, 0x00, 0x00, 0x00, 0x00
};
#endif /* DOINIT */
