...
SIMULATOR_BUILD_FLAGS="-I$PREFIX/include -I$SIMULATOR_SDK_PATH/usr/include $ARCH_FLAGS $MIN_VERSION_TAG -isysroot $SIMULATOR_SDK_PATH $BITCODE_BUILD_FLAGS"
SIMULATOR_LINK_FLAGS="$ARCH_FLAGS -L$PREFIX/lib -L$SIMULATOR_SDK_PATH/usr/lib"

DEVICE_BUILD_FLAGS="-I$PREFIX/include -I$DEVICE_SDK_PATH/usr/include $ARCH_FLAGS $MIN_VERSION_TAG -isysroot $DEVICE_SDK_PATH $BITCODE_BUILD_FLAGS"
DEVICE_LINK_FLAGS="$ARCH_FLAGS -L$PREFIX/include -L$DEVICE_SDK_PATH/usr/lib $BITCODE_LINK_FLAGS"
