...
cat='cat'
cc='/usr/bin/clang'
cccdlflags='  -arch arm64 -miphoneos-version-min=8.0 -isysroot/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk'
ccdlflags=' '
...
cf_time='Thu May 21 09:08:29 CEST 2020'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
ld_can_script='undef'
lddlflags=' -miphoneos-version-min=8.0 -bundle -undefined dynamic_lookup -arch arm64 -DTARGET_OS_IPHONE -arch arm64 -L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/usr/lib -Wl,-headerpad_max_install_names -bundle -L/opt/local/lib -fstack-protector-strong'
ldflags=' -miphoneos-version-min=8.0 -arch arm64 -DTARGET_OS_IPHONE -arch arm64 -L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/usr/lib -Wl,-headerpad_max_install_names -fstack-protector-strong -L/opt/local/lib'
