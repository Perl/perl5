 ...
 *
 * (Note, proper general operation of the bare libc functions requires you
...
Combines Newx() and Copy() into a single macro.  Dest will be allocated using
Newx() and then src will be copied into it.
