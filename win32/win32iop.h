...
/* compatibility stub for 5.004_0x series */

typedef struct { int dummy; }	WIN32_IOSUBSYSTEM;
typedef WIN32_IOSUBSYSTEM	*PWIN32_IOSUBSYSTEM;

DllExport PWIN32_IOSUBSYSTEM	SetIOSubSystem(void *pio);
DllExport PWIN32_IOSUBSYSTEM	GetIOSubSystem(void);
