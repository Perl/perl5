...
cf_time='Mon Nov  1 15:49:13 CET 2004'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
libsfound=' /usr/lib/libnsl.so /usr/lib/libgdbm.so /usr/local/lib/libdb.so /usr/lib/libdl.so /usr/lib/libm.so /usr/lib/libcrypt.so /usr/lib/libutil.so /usr/lib/libc.so'
...
myhostname='yourhost'
myuname='linux lt09 2.6.5-7.111-default #1 wed oct 13 15:45:13 utc 2004 i686 i686 i386 gnulinux '
n='-n'
need_va_copy='undef'
...
vendorscriptexp=''
version='5.9.2'
version_patchlevel_string='version 9 subversion 2 patch 23438'
versiononly='define'
vi=''
voidflags='15'
