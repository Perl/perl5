...
# Configuration time: Tue Jan 30 07:23:37 EET 2001
# Configured by     : jhi
...
ccname='cc'
ccsymbols='__alpha=1 __ALPHA=1 __Alpha_AXP=1 __DECC=1 __DECC_MODE_COMMON=1 __DECC_VER=50990010 __IEEE_FLOAT=1 __INITIAL_POINTER_SIZE=0 __LANGUAGE_C__=1 __osf__=1 __PRAGMA_ENVIRONMENT=1 __unix__=1 __X_FLOAT=0 _LONGLONG=1 _SYSTYPE_BSD=1 SYSTYPE_BSD=1 unix=1'
ccversion='V5.9-010'
cf_by='jhi'
cf_email='yourname@yourhost.yourplace.com'
cf_time='Tue Jan 30 07:23:37 EET 2001'
charsize='1'
chgrp=''
chmod=''
chown=''
...
ksh=''
ld='ld'
lddlflags='-shared -expect_unresolved "*" -O -msym -std -s'
ldflags=''
