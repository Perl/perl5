...
Code freezes (which happen in the 5.25.X series)
  ...
  2017-01-20  5.25.7          Contentious changes freeze
  2017-02-20  5.25.8          User-visible changes freeze
  2017-03-20  5.25.9          Full code freeze
...
(RC0 for 5.25.0 will be released once we think that all the blockers have been
