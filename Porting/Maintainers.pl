...
%Modules = (
    ...
    'ExtUtils::CBuilder' => {
        'DISTRIBUTION' => 'AMBS/ExtUtils/ExtUtils-CBuilder-0.280217.tar.gz',
    ...
    'HTTP::Tiny' => {
        'DISTRIBUTION' => 'DAGOLDEN/HTTP-Tiny-0.048.tar.gz',
    ...
    'Module::CoreList' => {
        'DISTRIBUTION' => 'BINGOS/Module-CoreList-5.021003.tar.gz',
