...
probably a reasonable name for perl7 to use."
...
options would be nice for perl 7.0.0.
...
API level in L<perlapi>, and L<perl7140delta/Custom per-subroutine check hooks>
