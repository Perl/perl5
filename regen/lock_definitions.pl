...
#   h)  The string "XC", which stands for "Cross-call".  This means that the
...
#
#   i)  The string "init".  This means that the functions in the 'uses' column
...
#       startup.
#
#   j)  The string "sig:" followed by the name of a signal.  For example
...
#
#   k)  The string "skip".  This means to suppress the lock definitions.
#       Hopefully there are comments saying why.
#
#   l)  The string "timer".  This appears to be obsolete, with sig:ALRM taking
#       over its meaning.  The code here simply verifies that this string
#       doesn't appear without also "sig:ALRM"
#
#   m)  Any other string of \w characters, none uppercase.  For example,
...
#
#   n)  The string "const:" followed by a tag word (\w+).  This means that the
...
#       other such functions, or the functions in l) that have the same tag.
...
#
#   o)  The string "race".  This means that each of the specified uses has
...
#
#   p)  A string giving a locale category, like "LC_TIME".  This indicates
#       what locale category affects the execution of this use.  Multiple
#       ones may be specified.  These are for future use. XXX
#
#   q)  The string "//".  This must be the final field on the line, and
...
gethostbyaddr   | race:hostbyaddr env locale Ogetnameinfo                \
                  // return needs a deep copy for safety
gethostbyaddr_r | env locale X Ogetnameinfo
gethostbyname   | race:hostbyname env locale Ogetaddrinfo                   \
                  // return needs a deep copy for safety
...
getprotoent     | XC race:protoent race:protoentbuf locale
...
getservbyname   | race:servbyname locale Ogetaddrinfo
getservbyname_r | locale X  Ogetaddrinfo
getservbyport   | race:servbyport locale Ogetnameinfo
getservbyport_r | locale X Ogetnameinfo
getservent      | XC race:servent race:serventbuf locale
