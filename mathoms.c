...
PERL_CALLCONV bool Perl_do_open(pTHX_ GV *gv, register char *name, I32 len, int as_raw, int rawmode, int rawperm, PerlIO *supplied_fp);
...
void
Perl_pack_cat(pTHX_ SV *cat, char *pat, char *patend, register SV **beglist, SV **endlist, SV ***next_in_list, U32 flags)
{
