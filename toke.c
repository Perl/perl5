    ...
    )
{
    ...
    U8 open_delim_str[UTF8_MAXBYTES+1];
    ...
    if (!UTF || UTF8_IS_INVARIANT(close_delim_byte0)) {
           open_delim_code  = open_delim_str[0]
         = close_delim_code = close_delim_str[0] = close_delim_byte0;
        delim_byte_len = 1;
    }
    else {
        ...
        Copy(s,  open_delim_str, delim_byte_len, U8);
