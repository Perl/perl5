...
BEGIN
{
   ...
   eval ' use IO::Uncompress::Adapter::Inflate 2.222 ;';
   eval ' use IO::Uncompress::Adapter::Bunzip2 2.222 ;';
   ...
   eval ' use IO::Uncompress::Bunzip2 2.222 ;';
   eval ' use IO::Uncompress::UnLzop 2.217 ;';
   eval ' use IO::Uncompress::Gunzip 2.222 ;';
   eval ' use IO::Uncompress::Inflate 2.222 ;';
   eval ' use IO::Uncompress::RawInflate 2.222 ;';
   eval ' use IO::Uncompress::Unzip 2.222 ;';
