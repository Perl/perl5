...
is ($conf->{build}{stamp}, "Jul  5 2025 09:58:46", "Build time");
is ($conf->{config}{version}, "5.42.0", "reconstructed \$Config{version}");
...
my $md5 = $@ ? "0" x 32 : "c9059d95d503f14acf267d22fe5fa762";
...
Summary of my perl5 (revision 5 version 42 subversion 0) configuration:
  ...
  Platform:
    ...
    uname='linux lx09 6.15.4-1-default #1 smp preempt_dynamic mon jun 30 10:37:39 utc 2025 (55e70a8) x86_64 x86_64 x86_64 gnulinux '
    config_args='-Duse64bitall -Dusequadmath -Dusethreads -Duseithreads -Duseshrplib -Uversiononly -Dinc_version_list=none -des'
    hint=recommended
    useposix=true
    d_sigaction=define
...
Characteristics of this binary (from libperl): 
  Compile-time options:
    ...
    USE_THREAD_SAFE_LOCALE
  Built under linux
  Compiled at Jul  5 2025 09:58:46
  %ENV:
    PERL6LIB="inst#/pro/3gl/CPAN/rakudo/install"
  @INC:
    /pro/lib/perl5/site_perl/5.42.0/x86_64-linux-thread-multi-quadmath
    /pro/lib/perl5/site_perl/5.42.0
    /pro/lib/perl5/5.42.0/x86_64-linux-thread-multi-quadmath
    /pro/lib/perl5/5.42.0
