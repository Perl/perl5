...
EOF
    ...
    $pi -> _dng() if $downgrade && ($pi -> is_int() ||
                                    $pi -> is_inf() || $pi -> is_nan());
...
sub bmodpow {
    ...
    $num -> round(@r);
    $num -> _dng() if $downgrade && ($num -> is_int() ||
                                     $num -> is_inf() || $num -> is_nan());
    return $num;
}
...
sub batan {
    ...
    return $x -> _dng() if $downgrade && ($x -> is_int() || $x -> is_inf());
    $x;
}
...
sub bfloor {
    ...
    $x -> round(@r);
    $x -> _dng() if $downgrade && ($x -> is_int() || $x -> is_inf());
    return $x;
}
