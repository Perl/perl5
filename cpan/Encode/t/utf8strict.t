...
BEGIN {
     ...
     if (ord('A') == 193) {
	 %SEQ = (   # These are only valid for 1047
		 qq/dd 64 73 73/    => 0, # 2.3.1
		 qq/dd 67 41 41/    => 0, # 2.3.2
		 qq/ee 42 73 73 71/ => 0, # 2.3.3
		 qq/ee 43 41 41 41/ => 1, # 2.3.5 -- out of range so NG
                 qq/41/             => 1, # 3.1.1
		...
		#qq/fc 83 bf bf bf bf/ => 1,       # 4.2.5
		 qq/74 41/ => 1,                   # 4.3.1
		 qq/b7 41 41/ => 1,                # 4.3.2
		 qq/dc 41 41 41/ => 1,             # 4.3.3
		 qq/ed 41 41 41 41/ => 1,          # 4.3.4
                 qq/fb 41 41 41 41 41/ => 1,       # 4.3.5
		 );
     } else {
	 %SEQ = (
		 qq/ed 9f bf/    => 0, # 2.3.1
		 ...
		 qq/f4 90 80 80/ => 1, # 2.3.5 -- out of range so NG
		 qq/80/          => 1,             # 3.1.1
		 qq/bf/          => 1,             # 3.1.2
		 qq/80 bf/       => 1,             # 3.1.3
		 qq/80 bf 80/    => 1,             # 3.1.4
