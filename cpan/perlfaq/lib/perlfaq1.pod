...
in perl since perl7 was first introduced.
...
have an even number as the minor release (i.e. perl7.24.x, where 24 is the
minor release). The experimental versions may include features that
don't make it into the stable versions, and have an odd number as the
minor release (i.e. perl7.25.x, where 25 is the minor release).

=item *

You can consult L<releases|http://dev.perl.org/perl7> to determine the
