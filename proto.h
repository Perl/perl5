...
PERL_CALLCONV UV
Perl_grok_uint_by_base(pTHX_ const char * const start, STRLEN *len_p, I32 *flags, NV *result, U8 max_permissible_bits, unsigned shift1, unsigned shift2, const U8 lookup_bit, const U8 offset);
