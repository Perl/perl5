...
exe_ext=''
expr='expr'
extensions='B ByteLoader Data/Dumper DB_File Devel/DProf Devel/PPPort Devel/Peek Digest/MD5 DynaLoader Encode Fcntl File/Glob Filter/Util/Call I18N/Langinfo IO List/Util MIME/Base64 NDBM_File Opcode POSIX PerlIO/Scalar PerlIO/Via PerlIO/encoding Socket Storable Sys/Hostname Time/HiRes Unicode/Normalize XS/Typemap attrs re Compress/Zlib HTML/Parser'
fflushNULL='define'
fflushall='undef'
find=''
