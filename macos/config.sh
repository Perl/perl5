...
exe_ext=''
expr='expr'
extensions='B ByteLoader Data/Dumper DB_File Devel/DProf Devel/Peek DynaLoader Fcntl File/Glob IO NDBM_File Opcode POSIX Socket Sys/Hostname attrs re Compress/Zlib Digest/MD5 HTML/Parser List/Util MIME/Base64 Storable Time/HiRes'
fflushNULL='define'
fflushall='undef'
find=''
...
startsh=''
static_ext='B ByteLoader Data/Dumper DB_File Devel/DProf Devel/Peek DynaLoader Fcntl File/Glob IO NDBM_File Opcode POSIX Socket Sys/Hostname attrs re Compress/Zlib Digest/MD5 HTML/Parser List/Util MIME/Base64 Storable Time/HiRes'
stdchar='char'
stdio_base=''
stdio_bufsiz=''
stdio_cnt=''
