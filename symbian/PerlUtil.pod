...
=head1 SYNOPSIS
   ...
   static HBufC8*  newHBufC8fromPVn(const U8* s, size_t n);
   static void     setTDes8fromPVn(TDes8* aDes8, const U8* s, size_t n);
   static HBufC16* newHBufC16fromPVn(const U8* s, size_t n, bool utf8);
   static void  setTDes16fromPVn(TDes16* aDes16, const U8* s, size_t n);
