...
#define do_op_jsondump(a,b,c)	Perl_do_op_jsondump(aTHX_ a,b,c)
#define do_pmop_jsondump(a,b,c)	Perl_do_pmop_jsondump(aTHX_ a,b,c)
#define jsondump_all()		Perl_jsondump_all(aTHX)
#define jsondump_all_perl(a)	Perl_jsondump_all_perl(aTHX_ a)
#define jsondump_eval()		Perl_jsondump_eval(aTHX)
#define jsondump_form(a)	Perl_jsondump_form(aTHX_ a)
#ifndef PERL_IMPLICIT_CONTEXT
#define jsondump_indent		Perl_jsondump_indent
#endif
#define jsondump_packsubs(a)	Perl_jsondump_packsubs(aTHX_ a)
#define jsondump_packsubs_perl(a,b)	Perl_jsondump_packsubs_perl(aTHX_ a,b)
#define jsondump_sub(a)		Perl_jsondump_sub(aTHX_ a)
#define jsondump_sub_perl(a,b)	Perl_jsondump_sub_perl(aTHX_ a,b)
#define jsondump_vindent(a,b,c,d)	Perl_jsondump_vindent(aTHX_ a,b,c,d)
...
#define op_jsondump(a)		Perl_op_jsondump(aTHX_ a)
#define package(a)		Perl_package(aTHX_ a)
#define pad_peg			Perl_pad_peg
#define pmop_jsondump(a)	Perl_pmop_jsondump(aTHX_ a)
...
#define sv_jsonpeek(a)		Perl_sv_jsonpeek(aTHX_ a)
