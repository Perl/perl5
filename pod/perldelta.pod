...
coming in, a warning is immediately given about it - instead of being
silent about it and Perl being unhappy about the broken data later.
...
=head2 Module and pragma specific fixes
...
get many warnings like this:
    ...
    cc: "/usr/include/sys/socket.h", line 505: warning 562: Redeclaration of "sendfile" with a different storage class specifier: "sendfile" will have internal linkage.
