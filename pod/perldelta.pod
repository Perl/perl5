...
perldelta - what is new for perl v5.43.12

=head1 DESCRIPTION

This document describes differences between the 5.43.11 release and the 5.43.12
release.

If you are upgrading from an earlier release such as 5.43.10, first read
L<perl54311delta>, which describes differences between 5.43.10 and 5.43.11.
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.43.11..HEAD
