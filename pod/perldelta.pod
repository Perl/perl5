...
=for comment XXX
This has been completed up to e57c1822.
...
C<shasum> now more closely mimics C<sha1sum>/C<md5sum>, and C<Addfile>
...
C<ExtUtils::Constant> has been upgraded from 0.02 to 0.03.
...
The C<mg_findext()> and C<sv_unmagicext()> functions have been added to the API.
...
C<parse_arithexpr()> functions have been added to the API.  They perform
