...
preceeded by its index within that list. This is primarily useful for using
...
example.  See L<feature/The 'extra_paired_delimiters' feature> for
details.
...
Using any of the characters enabled by
L</Added experimental feature 'extra_paired_delimiters'> as a
non-paired string delimiter is now deprecated.
