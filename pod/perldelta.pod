...
perldelta - what is new for perl v5.39.3
...
Don't set C<MACOSX_DEPLOYMENT_TARGET> when building on OS X 10.5.  [GH
#21367]
...
Declared references can now be used with C<state> variables. [GH #21351]
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.39.2..HEAD
