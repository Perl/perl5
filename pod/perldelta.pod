...
=head2 Constructs enclosed in curly braces in double-quotish contexts
and regular expressions may now have optional blanks within but adjacent
to the braces.
...
This ability is effect regardless of the presence of the C</x> regular
