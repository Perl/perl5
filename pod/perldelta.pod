...
perldelta - what is new for perl v5.39.2
...
stack alignment, which 32-bit Windows does not preserve. [GH #21313]
...
size rather than C<SSize_t> or C<STRLEN>/C<size_t> [GH #21012]:
...
msgrcv() incorrectly called get magic on the bufffer SV and failed to
call set magic on completion. [GH #21012]
