...
There are no changes intentionally incompatible with Perl 5.40.0.  If any
...
and
    ...
    # Two-variable for loop over a list returned from a call to a lexical(ly
    # imported) subroutine, all inside a lexically scoped or anonymous
    # subroutine:
    my sub foo { ... }
    my $fn = sub {
        for my ($x, $y) (foo()) { ... }
