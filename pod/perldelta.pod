...
Some tests fail on Windows. This needs further investigation.
  ...
  Test Summary Report
  -------------------
  ../cpan/Win32/t/GetFolderPath.t                (Wstat: 0 Tests: 1 Failed: 1)
    Failed test:  1
  ../cpan/Win32API-File/t/file.t                 (Wstat: 0 Tests: 270 Failed: 1)
    Failed test:  41
  ../ext/XS-APItest/t/locale.t                   (Wstat: 1280 (exited 5) Tests: 63 Failed: 0)
