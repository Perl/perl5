...
This section describes the differences between the 5.005_04 and
5.005_05 releases. 5.005_05 is mainly an operating system
compatibility release.

Perl now compiles and runs under modern Unix systems, including those
with recent Berkeley DB libraries or GCC.
