...
perldelta - what is new for perl v5.41.1
...
Document when each L<builtin> function was first available and stabilized.
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.41.0..HEAD
