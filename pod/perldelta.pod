...
32-bit Windows.  [GH #22393]

=item *

The podlators distribution, which provides the L<Pod::Man> and L<Pod::Text>
modules and the L<pod2man> and L<pod2text> command-line utilities, has been
upgraded from version 5.01 to v6.0.2.  The distribution now uses semantic
...
were released on the next L<FREETMPS|perlapi/FREETMPS>. [GH
#22255]
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.41.1..HEAD
