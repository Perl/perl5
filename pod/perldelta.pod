...
=item Internal C API functions now hidden
...
>>>>>>> b9feb3cba1 (Move POSIX::localeconv() logic to locale.c)

=item my_strftime8()

This is a new function which acts like L<perlapi/my_strftime> but also
returns a boolean as to whether or not the returned time string is
encoded as UTF-8.

=item my_langinfo8()

This is a new function which acts like L<perlapi/Perl_langinfo> but also
returns a boolean as to whether or not the returned time string is
encoded as UTF-8.
