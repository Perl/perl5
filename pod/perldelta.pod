...
now, this should fix it, we hope.
...
Several VMS-specific routines dealing with filesystem access were leaking
memory.
...
C<use VERSION> and C<no VERSION> no longer leak memory [perl #78436]
[perl #69050].
