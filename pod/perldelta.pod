...
perldelta - what is new for perl v5.42.4

=head1 DESCRIPTION

This document describes differences between the 5.42.3 release and the 5.42.4
release.

If you are upgrading from an earlier release such as 5.42.2, first read
L<perl5423delta>, which describes differences between 5.42.2 and 5.42.3.
