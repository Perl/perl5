...
perldelta - what is new for perl v5.40.6

=head1 DESCRIPTION

This document describes differences between the 5.40.5 release and the 5.40.6
release.

If you are upgrading from an earlier release such as 5.40.4, first read
L<perl5405delta>, which describes differences between 5.40.4 and 5.40.5.
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.40.5..HEAD
