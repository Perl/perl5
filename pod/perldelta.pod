...
perldelta - what is new for perl v5.41.14

=head1 DESCRIPTION

This document describes differences between the 5.41.13 release and the 5.41.14
release.

If you are upgrading from an earlier release such as 5.41.12, first read
L<perl54113delta>, which describes differences between 5.41.12 and 5.41.13.
