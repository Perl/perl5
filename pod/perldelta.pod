...
L<Module::CoreList> has been upgraded from version 5.20250702 to 5.20260622.
...
=item * A compilation error in unthreaded builds using MSVC introduced in Perl 5.43.5
...
contributed the improvements that became Perl 5.42.1:
