...
On Win32, C<waitpid(-1, WNOHANG)> could sometimes have a very large timeout.
...
and contains approximately 6,900 lines of changes across 80 files from 22
authors.

Excluding auto-generated files, documentation and release tools, there were
approximately 1,200 lines of changes to 23 .pm, .t, .c and .h files.
...
Maischein, Nicolas R., Ricardo Signes, Sawyer X, Sevan Janiyan, Steve Hay, Tom
Hukins, Tony Cook.
