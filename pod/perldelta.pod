...
perldelta - what is new for perl v5.37.12

=head1 DESCRIPTION

This document describes differences between the 5.37.11 release and the 5.37.12
release.

If you are upgrading from an earlier release such as 5.37.10, first read
L<perl53711delta>, which describes differences between 5.37.10 and 5.37.11.
