...
- RT #129387: IPC::SysV memory operations limited to 31-bit offsets
- Add strict and warnings to the test suite
- Switch IPC::SysV to use XSLoader
...
L<Math-Complex> has been upgraded from version 1.59_01 to 1.59_02.

- enable strict and warnings in test suite
- fix a unit issue from t/Complex.t
...
-  Provide PERL_VERSION_* compare macro
...
L<Exporter> has been upgraded from 5.74 version to 5.75.

Store version directly in Exporter::Heavy

L<ExtUtils-ParseXS> has been upgraded from 3.40 version to 3.41.
...
- Fix a spurious error reported for regular file handles
- Enforce strict and warnings.
- Avoid using indirect.
- Fix a flapping test on Windows.
...
L<Unicode-Normalize> has been upgraded from 1.27 version to 1.28.
