...
follows:
    ...
    Q	An unsigned quad value.
	  (Works only on native 64-bit platforms.
           Causes a fatal runtime error otherwise.)
...
produces the output 'h:i:t:h:e:r:e'. It does not match the
null at the start or end of the string (note that this behavior
differs from that of the equivalent regular expression).
