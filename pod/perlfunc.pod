...
(C<push my @bar, @baz> etc. is also possible, but like many other shortcuts
in Perl, we don't document them because they are too easy for the user
to mess up. Just stick to C<my @bar; push @bar, @baz> and you'll be safe.)
