...
L<C<trim>|/trim EXPR> is available only if the
L<C<trim> feature|feature/The 'trim' feature> is enabled or
if it is prefixed with C<CORE::>.  The trim function is enabled
