...
L<perldata/"Typeglobs and Filehandles"> for passing filehandles and/or
dirhandles into or out of subroutines, or storing into larger data
structures.  Its advantage is it avoids any possible unexpected consequences
of typeglob assignment.  But if all you do is assign the incoming parameter
to a scalar, as shown below, either works.
