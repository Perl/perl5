...
the command-line.
 ...
 $> perl -d:DProf wordmatch -f perl7db.pl

 <...multiple lines snipped...>

 wordmatch report for perl7db.pl:
 lines in file: 9428
 words in file: 50243
...
flag, you pull C<Devel::Profiler> in directly as a module using C<-M>.
 ...
 $> perl -MDevel::Profiler wordmatch -f perl7db.pl
...
C<-d> flag to Perl at runtime.
 ...
 $> perl -d:SmallProf wordmatch -f perl7db.pl
...
supply the C<-d> argument to Perl:
 ...
 $> perl -d:FastProf wordmatch -f perl7db.pl
...
the code.
 ...
 $> perl -d:NYTProf wordmatch -f perl7db.pl
