...
The seven routines are:
    ...
    SV*  newSVuv(UV);
    SV*  newSVnv(double);
    SV*  newSVpv(const char*, size_t);
    SV*  newSVpvn(const char*, size_t);
    SV*  newSVpvf(const char*, ...);
    SV*  newSVsv(SV*);

C<size_t> is an integer type (size_t, usually defined as size_t in
...
To change the value of an I<already-existing> SV, there are eight routines:
    ...
    void  sv_setpvn(SV*, const char*, size_t)
    void  sv_setpvf(SV*, const char*, ...);
    void  sv_vsetpvfn(SV*, const char*, size_t, va_list *,
                                                    SV **, I32, bool *);
    void  sv_setsv(SV*, SV*);
...
you can use the following functions:
    ...
    void  sv_catpvn(SV*, const char*, size_t);
    void  sv_catpvf(SV*, const char*, ...);
    void  sv_vcatpvfn(SV*, const char*, size_t, va_list *, SV **,
                                                             I32, bool);
    void  sv_catsv(SV*, SV*);
...
SVt_PVMG, Perl may core dump.
    ...
    int mg_copy(SV* sv, SV* nsv, const char* key, size_t klen);
...
But it also puts the same information in certain fields of the XSUB itself:
    ...
    size_t name_length  = SvCUR(cv); /* in bytes */
...
whether the byte is encoded as a single byte even in UTF-8):
    ...
    size_t len; /* length of character in bytes */
