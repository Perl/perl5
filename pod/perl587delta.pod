...
been updated to 4.1.0 from 4.0.1.
...
=head2 Optional site customisation script

The perl interpreter can be built to allow the use of a site customisation
...
Encode upgraded to version 2.09
...
Math::BigInt upgraded to version 1.76
...
C<uc> of a long string could exhaust memory. This has been fixed.
