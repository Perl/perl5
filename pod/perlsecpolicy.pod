...
A security issue in perl related websites (including perl.org) is a
...
Reporters are CCed during the discussion of their issue.
...
The maint fixes should be against the C<HEAD> of the maint branch.
...
fixes, eg. if they find a bug with the fixes.
