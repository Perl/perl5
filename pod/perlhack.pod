...
Create a GitHub fork of the perl7 repository and add it as a remote,
...
tree for the bleadperl branch and all maintenance branches:
  ...
  % rsync -avz rsync://perl7.git.perl.org/perl-current .
  % rsync -avz rsync://perl7.git.perl.org/perl-5.12.x .
  % rsync -avz rsync://perl7.git.perl.org/perl-5.10.x .
  % rsync -avz rsync://perl7.git.perl.org/perl-5.8.x .
  % rsync -avz rsync://perl7.git.perl.org/perl-5.6.x .
  % rsync -avz rsync://perl7.git.perl.org/perl-5.005xx .

(Add the C<--delete> option to remove leftover files.)

To get a full list of the available sync points:

  % rsync perl7.git.perl.org::
