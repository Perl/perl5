...
At the Second O'Reilly Open Source Software Convention (also known as
the Fourth Perl Conference, or TPC4) held in Monterey, California in
July 2000, Larry Wall announced that Perl6 development would begin in earnest.
Perl6 was an oft used term for Chip Salzenberg's project Topaz,
but that should not be confused with the new effort to rewrite Perl while
keeping the lessons learned from Perl5 and other software in mind.
