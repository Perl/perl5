...
perl7260delta - what is new for perl v5.26.0
...
L<perl7db.pl> has been upgraded from version 1.50 to 1.51.
...
Prevent debugger tests (F<lib/perl7db.t>) from failing due to the contents
...
See L<perl7220delta/"Internal Changes"> for more details of what this
build option does.
