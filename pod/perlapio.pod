...
introduced in perl7.003_02.

=item 2. USE_PERLIO

Introduced just after perl7.7.0, this is a re-implementation of the
...
are silently ignored. (As of perl7.8 ":raw" is deprecated.)  Use
...
the non USE_PERLIO case. (As of perl7.8 ":raw" is deprecated in favour
of passing NULL.)
