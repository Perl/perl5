...
perl7200delta - what is new for perl v5.20.0
...
L<perl7180delta>, which describes differences between 5.16.0 and 5.18.0.
...
v5.18.0|perl7180delta/Internal Changes>, this means longer uninitialized my
...
all extensions statically (into perl720.dll, and into a separate
...
to perl7-security-report@perl.org.  This points to a closed subscription
