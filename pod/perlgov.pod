...
Core Team member objects, the Special Election must be organized within one
week.
...
Administrator.  If only one candidate has been nominated, no vote is required,
and that candidate will be declared the winner when the nomination period ends.
