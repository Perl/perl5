...
Administrator.  Unless there are more candidates than open seats, no vote is
required, and those candidates will be declared the winner when the nomination
period ends.
