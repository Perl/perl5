...
perl7121delta - what is new for perl v5.12.1
...
L<perl7120delta>, which describes differences between 5.10.1 and
5.12.0.
...
We fixed a minor error in L<perl7114delta.pod>.
...
F<perl7db.t>: Fix for test failures when C<Term::ReadLine::Gnu> is installed.
