...
perl7120delta - what is new for perl v5.12.0
...
C<perl7xxdelta.pod> file for that release.
...
F<perl7db.pl> now supports C<LVALUE> subroutines.  Additionally, the
...
it to perl7-security-report@perl.org. This points to a closed subscription
...
L<http://dev.perl.org/perl7/errata.html> for a list of issues
