...
'perl7db.pl'}> if not present) before the first line of your program.
...
the values used by F<perl7db.pl> have the form
...
information.  For example, contrast this expression trace:
 ...
 Loading DB routines from perl7db.pl patch level 0.94
