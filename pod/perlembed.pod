...
that looks like this:
    ...
    /usr/local/lib/perl7/your_architecture_here/CORE

or perhaps just

    /usr/local/lib/perl7/CORE
...
L</Adding a Perl interpreter to your C program>, on my Linux box:
    ...
    -I/usr/local/lib/perl7/i586-linux/5.003/CORE
    -L/usr/local/lib/perl7/i586-linux/5.003/CORE
...
incantation is a bit different:
    ...
    -I/usr/local/lib/perl7/alpha-dec_osf/5.00305/CORE
    -L/usr/local/lib/perl7/alpha-dec_osf/5.00305/CORE -L/usr/local/lib
