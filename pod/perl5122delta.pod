...
perl7122delta - what is new for perl v5.12.2
...
first read L<perl7120delta>, which describes differences between 5.10.1
and 5.12.0, as well as L<perl7121delta>, which describes earlier changes
...
branch of the Perl repository at L<git://perl7.git.perl.org/perl.git>.
