...
written right to left, for example) Unicode supplies a Bidi_Class property.
...
General_Category property, this
...
whose ordinal is 0x100 or above, or which were specified using either of the
