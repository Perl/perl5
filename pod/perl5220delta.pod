...
perl7220delta - what is new for perl v5.22.0
...
L<perl7200delta>, which describes differences between 5.18.0 and 5.20.0.
...
L<perl7db.pl> has been upgraded to version 1.49.
...
When trying to emit warnings, perl's default debugger (F<perl7db.pl>) was
