...
C<Dynaloader> upgraded from version 1.09 to 1.10
...
C<ExtUtils::MakeMaker> upgraded from version 6.42 to 6.53_03
...
C<ExtUtils::ParseXS> upgraded from version 2.18_02 to 2.20

=item *

C<Fatal> upgraded from version 1.05 to 2.05. See also the new pragma
C<autodie>.
...
C</UNIVERSAL> upgraded from version 1.04 to version 1.05
