...
stored under F<ext/Foo/Bar/> is now located under F<ext/Foo-Bar/>. This
should make no difference to the compilation or installation of perl,
unless you have a very customised build process that explicitly relies on
this structure, or which hard-codes the C<nonxs_ext> F<Configure>
parameter.
...
C<Archive::Tar> upgraded from version 1.38 to 1.44
...
C<Devel::PPPort> upgraded from version 3.13 to 3.16

=item *

C<DB_File> upgraded from version 1.816_1 to 1.819
...
C<Encode> upgraded from version 2.23 to 2.31
...
C<IPC::SysV> upgraded from version 1.05 to 2.00_02 XXX
...
C<ExtUtils::MakeMaker> upgraded from version 6.42 to 6.49_01
...
C<Module::Build> upgraded from version 0.2808_01 to 0.31_04
...
C<Time::Piece> upgraded from version 1.12 to 1.13_02
