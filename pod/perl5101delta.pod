...
C<Compress::Raw::Bzip2> has been added to the core (version 2.018).
...
C<Archive::Tar> upgraded from version 1.38 to 1.48
...
C<Compress::Zlib> upgraded from version 2.008 to 2.018
...
C<CPANPLUS::Dist::Build> upgraded from version 0.06_02 to 0.24
