...
F<Configure> parameter. Specifically, this change does not alter the
...
C<CPANPLUS::Dist::Build> upgraded from version 0.06_02 to 0.14
...
C<Encode> upgraded from version 2.23 to 2.32
