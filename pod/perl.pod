...
F<http://www.perl.com/CPAN/src/index.html>
        ...
        BSD/OS          MPE/iX          SVR4
        DG/UX		NetBSD          UNICOS
        Digital UNIX    OpenSTEP        VMS
        DOS DJGPP 1)    OS/2            Windows 3.1     1)
        DYNIX/ptx       OS390   2)      Windows 95      1),3)
        FreeBSD         PowerUX         Windows 98      1),3)
        HP-UX           QNX             Windows NT      1),3)
        IRIX                            VOS
