...
platforms. The following situation is as of February 1999 and Perl
5.005_03.
...
F<http://www.perl.com/CPAN/src/index.html>
        ...
        BeOS            MachTen         SunOS
        BSD/OS          MPE/iX          SVR4
        Digital UNIX    NetBSD          UNICOS
        DOS DJGPP       OpenSTEP        VMS
        DYNIX/ptx       OS/2            Windows 3.1     2)
        FreeBSD         OS390   1)      Windows 95      3)
        HP-UX           PowerUX         Windows 98      3)
        IRIX            QNX             Windows NT      3)
                                        VOS
        1) formerly known as MVS
        2) either the DOS or OS/2 ports can be used
...
either because the hardware/software platforms are rather rare
or because we don't have an active champion on these platforms.

        3b1             EP/IX           Plan 9
        AmigaOS         ESIX            RISC/os
        A/UX            FPS             Stellar
        ConvexOS        GENIX           SVR2
        CX/UX           Greenhills      TI1500
        DC/OSx          ISC             TitanOS
        DDE SMES        MiNT            Ultrix
        DGUX            MPC             UNICOS/mk
        DomainOS        NEWS-OS         Unisys Dynix
        DOS EMX         NextSTEP        Unixware
        Dynix           OpenBSD
                        Opus
