...
perldelta - what is new for perl v5.10.2

=head1 DESCRIPTION

This document describes differences between the 5.10.1 release and
the 5.10.2 release.

If you are upgrading from an earlier release such as 5.8.x, first read
the L<perl5100delta>, which describes differences between 5.8.0 and
5.10.0, then L<perl5101delta>.
...
XXX For a release on a stable branch, this section aspires to be:
    ...
    There are no changes intentionally incompatible with 5.10.2. If any
