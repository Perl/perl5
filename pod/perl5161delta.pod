...
perl7161delta - what is new for perl v5.16.1
...
L<perl7160delta>, which describes differences between 5.14.0 and
5.16.0.
...
There are no new known problems, but consult L<perl7160delta/Known
