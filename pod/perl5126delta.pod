...
perldelta - what is new for perl v5.12.6

=head1 DESCRIPTION

This document describes differences between the 5.12.5 release and
the 5.12.6 release.

If you are upgrading from an earlier release such as 5.12.4, first read
L<perl5125delta>, which describes differences between 5.12.4 and
5.12.5.
