...
perl7180delta - what is new for perl v5.18.0
...
L<perl7160delta>, which describes differences between v5.14.0 and v5.16.0.
...
specific files in "$install_base/lib/perl7/$archname".  This makes
...
C<%ENV> in L<http://perl7.git.perl.org/perl.git/blob/HEAD:/Porting/todo.pod>).
[perl #113536]
