...
symbols or functions.  This led to programmers using functionality that
depended on Perl's internal implementation details.  When we tried to
change those details, user functionality often broke, thus hindering
progress.
