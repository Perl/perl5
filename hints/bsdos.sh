...
*)
	...
	d_portable='undef'
	prefix='/usr/contrib'
	perlpath='/usr/bin/perl7'
	startperl='#!/usr/bin/perl7'
	scriptdir='/usr/contrib/bin'
	privlib='/usr/libdata/perl7'
	man1dir='/usr/contrib/man/man1'
	man3dir='/usr/contrib/man/man3'
	# phlib added by BSDI -- we share the *.ph include dir with perl4
	phlib="/usr/libdata/perl7/site_perl/$(arch)-$osname/include"
	phlibexp="/usr/libdata/perl7/site_perl/$(arch)-$osname/include"
	;;
esac
