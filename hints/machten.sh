...
# precise details of how this is achieved.  Improvements to perl's
# malloc() in versions greater than 5.004_50 currently crash MachTen,
# and so are disabled by -DPLAIN_MALLOC and -DNO_FANCY_MALLOC.
...
# malloc() is not used.  This is harmless.
case "$usemymalloc" in
