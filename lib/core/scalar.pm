...
1;
# core::scalar routines are installed from universal.c
__END__

=head1 NAME

core::scalar - utilities for introspecting properties of scalar variables

=head1 SYNOPSIS

    # core::scalar routines are "always loaded"
    my $type  = core::scalar::reftype($var);
    my $addr  = core::scalar::refaddr($var);
    my $class = core::scalar::blessed($var);

    my $ref= \@foo;
    core::scalar::weaken($ref);
    my $isweak= core::scalar::isweak($ref);

    # import core::scalar routines into your namespace
    use core::scalar qw(reftype refaddr blessed weaken isweak);

=head1 DESCRIPTION

The C<core::scalar> namespace is a perl internals reserved namespace for utility
