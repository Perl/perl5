...
our %Offsets = (
    ...
    # Warnings Categories added in Perl 5.023
    'everything'			=> 132,
    'extra'				=> 134,
    'void_unusual'			=> 136,
  );
...
our %Bits = (
    'all'				=> "\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x55\x05\x00", # [0..65]
    ...
    'experimental'			=> "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x40\x55\x51\x15\x00\x00", # [51..56,58..62]
...
our %DeadBits = (
    'all'				=> "\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\x0a\x00", # [0..65]
    ...
    'experimental'			=> "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\xaa\xa2\x2a\x00\x00", # [51..56,58..62]
...
our $DEFAULT				=  "\x10\x01\x00\x00\x00\x50\x04\x00\x00\x00\x00\x00\x00\x55\x51\x55\x00\x00", # [2,58,59,52,55,60,61,53,56,54,62,4,63,22,23,25]
our $LAST_BIT				=  138 ;
our $BYTES				=  18 ;
