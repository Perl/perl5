...
my @bf = (
    ...
    },
    {
        ...
        bitmask   => 3,
        enum      => [
            1, 'OPpTRANS_RESERVED_FOR_FUTURE_USE', 'RESERVED_FOR_FUTURE_USE',
...
our %defines = (
    ...
    OPpTRANS_MASK            =>   3,
    OPpTRANS_RESERVED_FOR_FUTURE_USE  =>   1,
    OPpTRANS_SHIFT           =>   0,
    OPpTRANS_SQUASH          =>   8,
...
our %labels = (
    ...
    OPpTRANS_RESERVED_FOR_FUTURE_USE  => 'RESERVED_FOR_FUTURE_USE',
