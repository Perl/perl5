...
$bits{blessed}{0} = $bf[0];
@{$bits{caller}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{catch}{0} = $bf[0];
$bits{ceil}{0} = $bf[0];
...
@{$bits{optarrow}}{3,2,1,0} = ('OPpOPTARROW_LVALUE_AASSIGN', 'OPpOPTARROW_LVALUE', 'OPpOPTARROW_CODEREF_PADSV', $bf[0]);
$bits{or}{0} = $bf[0];
...
our %defines = (
    ...
    OPpOPEN_OUT_RAW          =>  64,
    OPpOPTARROW_CODEREF_PADSV  =>   2,
    OPpOPTARROW_LVALUE       =>   4,
    OPpOPTARROW_LVALUE_AASSIGN  =>   8,
    OPpOUR_INTRO             =>  64,
    OPpPADHV_ISKEYS          =>   1,
...
our %labels = (
    ...
    OPpOPTARROW_CODEREF_PADSV  => 'CODEREF_PADSV',
    OPpOPTARROW_LVALUE       => 'LVALUE',
    OPpOPTARROW_LVALUE_AASSIGN  => 'LVALUE_AASSIGN',
...
our %ops_using = (
    ...
    OPpOPTARROW_CODEREF_PADSV  => [qw(optarrow)],
...
$ops_using{OPpOPTARROW_LVALUE} = $ops_using{OPpOPTARROW_CODEREF_PADSV};
$ops_using{OPpOPTARROW_LVALUE_AASSIGN} = $ops_using{OPpOPTARROW_CODEREF_PADSV};
