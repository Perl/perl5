...
$bits{$_}{6} = 'OPpSTATEMENT' for qw(and cond_expr or);
...
$bits{$_}{6} = 'OPpTRANS_USE_SVOP' for qw(trans transr);
...
my @bf = (
    ...
    },
    {
        ...
        bitmask   => 3,
        enum      => [
            1, 'OPpTRANS_ONLY_UTF8_INVARIANTS', 'ONLY_UTF8_INVARIANTS',
    ...
    },
    {
        ...
        enum      => [
            ...
            3, 'SVrt_CODE', 'CODE',
            4, 'SVrt_REF', 'REF',
            5, 'SVrt_SCALAR', 'SCALAR',
            6, 'SVrt_GLOB', 'GLOB',
            7, 'SVrt_REGEXP', 'REGEXP',
            8, 'SVrt_OBJECT', 'OBJECT',
            9, 'SVrt_LVALUE', 'LVALUE',
            10, 'SVrt_IO' , 'IO',
            11, 'SVrt_FORMAT', 'FORMAT',
            12, 'SVrt_VSTRING', 'VSTRING',
            13, 'SVrt_INVLIST', 'INVLIST',
...
$bits{avalues}{0} = $bf[0];
@{$bits{avhvswitch}}{1,0} = ($bf[3], $bf[3]);
$bits{backtick}{0} = $bf[0];
@{$bits{bind}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{binmode}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{bless}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{blessed}{0} = $bf[0];
...
$bits{catch}{0} = $bf[0];
$bits{ceil}{0} = $bf[0];
@{$bits{chdir}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{chmod}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{chomp}{0} = $bf[0];
$bits{chop}{0} = $bf[0];
@{$bits{chown}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{chr}{0} = $bf[0];
$bits{chroot}{0} = $bf[0];
@{$bits{close}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
...
@{$bits{dbmopen}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{defined}{0} = $bf[0];
...
$bits{dump}{0} = $bf[0];
$bits{each}{0} = $bf[0];
@{$bits{emptyavhv}}{5,3,2,1,0} = ('OPpEMPTYAVHV_IS_HV', $bf[5], $bf[5], $bf[5], $bf[5]);
...
@{$bits{enterwrite}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{eof}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{eq}}{1,0} = ($bf[1], $bf[1]);
@{$bits{equ}}{1,0} = ($bf[1], $bf[1]);
@{$bits{exec}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{exists}}{6,0} = ('OPpEXISTS_SUB', $bf[0]);
@{$bits{exit}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{exp}{0} = $bf[0];
$bits{fc}{0} = $bf[0];
@{$bits{fcntl}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{fileno}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{flip}{0} = $bf[0];
@{$bits{flock}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{floor}{0} = $bf[0];
$bits{flop}{0} = $bf[0];
@{$bits{formline}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{ftatime}{0} = $bf[0];
...
@{$bits{getpriority}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{getsockname}{0} = $bf[0];
$bits{ggrgid}{0} = $bf[0];
$bits{ggrnam}{0} = $bf[0];
@{$bits{ghbyaddr}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{ghbyname}{0} = $bf[0];
@{$bits{glob}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{gmtime}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{gnbyaddr}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{gnbyname}{0} = $bf[0];
$bits{goto}{0} = $bf[0];
$bits{gpbyname}{0} = $bf[0];
@{$bits{gpbynumber}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{gpwnam}{0} = $bf[0];
$bits{gpwuid}{0} = $bf[0];
$bits{grepstart}{0} = $bf[0];
$bits{grepwhile}{0} = $bf[0];
@{$bits{gsbyname}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{gsbyport}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
...
$bits{int}{0} = $bf[0];
@{$bits{ioctl}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{is_bool}{0} = $bf[0];
...
$bits{length}{0} = $bf[0];
@{$bits{link}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{list}{6} = 'OPpLIST_GUESSED';
@{$bits{listen}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
...
$bits{match}{7} = 'OPpMATCH_JUST_COUNT';
$bits{method}{0} = $bf[0];
$bits{method_named}{0} = $bf[0];
$bits{method_redir}{0} = $bf[0];
$bits{method_redir_super}{0} = $bf[0];
$bits{method_super}{0} = $bf[0];
@{$bits{methstart}}{7,6,0} = ('OPpINITFIELDS', 'OPpSELF_IN_PAD', $bf[0]);
@{$bits{mkdir}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{modulo}}{1,0} = ($bf[1], $bf[1]);
@{$bits{msgctl}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{msgget}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{msgrcv}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{msgsnd}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
...
@{$bits{pipe_op}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{pop}{0} = $bf[0];
$bits{pos}{0} = $bf[0];
$bits{postdec}{0} = $bf[0];
$bits{postinc}{0} = $bf[0];
...
@{$bits{push}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{pushdefer}}{7,0} = ('OPpDEFER_FINALLY', $bf[0]);
$bits{quotemeta}{0} = $bf[0];
@{$bits{rand}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{range}{0} = $bf[0];
@{$bits{read}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{readdir}{0} = $bf[0];
...
$bits{redo}{0} = $bf[0];
$bits{ref}{0} = $bf[0];
@{$bits{ref_cmp}}{7,6,5,4,3,2,1,0} = ('OPpREF_CMP_NE', 'OPpREF_CMP_AND', 'OPpREF_CMP_SKIPLOGOP', 'OPpREF_CMP_L2R', $bf[6], $bf[6], $bf[6], $bf[6]);
$bits{refaddr}{0} = $bf[0];
...
@{$bits{rename}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{repeat}}{6,1,0} = ('OPpREPEAT_DOLIST', $bf[1], $bf[1]);
$bits{require}{0} = $bf[0];
@{$bits{reset}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{reverse}}{3,0} = ('OPpREVERSE_INPLACE', $bf[0]);
$bits{rewinddir}{0} = $bf[0];
@{$bits{rindex}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{rmdir}{0} = $bf[0];
$bits{rv2av}{0} = $bf[0];
...
@{$bits{seek}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{seekdir}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{select}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{semctl}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{semget}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{semop}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{send}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{seq}}{1,0} = ($bf[1], $bf[1]);
@{$bits{sequ}}{1,0} = ($bf[1], $bf[1]);
@{$bits{setpgrp}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{setpriority}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{sge}}{1,0} = ($bf[1], $bf[1]);
@{$bits{sgt}}{1,0} = ($bf[1], $bf[1]);
$bits{shift}{0} = $bf[0];
@{$bits{shmctl}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{shmget}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{shmread}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{shmwrite}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{shostent}{0} = $bf[0];
@{$bits{shutdown}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{sin}{0} = $bf[0];
...
$bits{snetent}{0} = $bf[0];
@{$bits{sneu}}{1,0} = ($bf[1], $bf[1]);
@{$bits{socket}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{sockpair}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{sort}}{4,3,2,1,0} = ('OPpSORT_DESCEND', 'OPpSORT_INPLACE', 'OPpSORT_REVERSE', 'OPpSORT_INTEGER', 'OPpSORT_NUMERIC');
@{$bits{splice}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{split}}{4,3,2} = ('OPpSPLIT_ASSIGN', 'OPpSPLIT_LEX', 'OPpSPLIT_IMPLIM');
@{$bits{sprintf}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{sprotoent}{0} = $bf[0];
$bits{sqrt}{0} = $bf[0];
@{$bits{srand}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{srefgen}{0} = $bf[0];
@{$bits{sselect}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{sservent}{0} = $bf[0];
@{$bits{ssockopt}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{stat}{0} = $bf[0];
@{$bits{stringify}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{study}{0} = $bf[0];
...
@{$bits{sysopen}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{sysread}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{sysseek}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{system}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{syswrite}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{tell}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{telldir}{0} = $bf[0];
@{$bits{tie}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{tied}{0} = $bf[0];
@{$bits{trans}}{1,0} = ($bf[2], $bf[2]);
@{$bits{transr}}{1,0} = ($bf[2], $bf[2]);
@{$bits{truncate}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{uc}{0} = $bf[0];
$bits{ucfirst}{0} = $bf[0];
@{$bits{umask}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{undef}}{5,0} = ('OPpUNDEF_KEEP_PV', $bf[0]);
@{$bits{unlink}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{unpack}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
@{$bits{unshift}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{untie}{0} = $bf[0];
$bits{unweaken}{0} = $bf[0];
@{$bits{utime}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
$bits{values}{0} = $bf[0];
@{$bits{vec}}{1,0} = ($bf[1], $bf[1]);
@{$bits{waitpid}}{3,2,1,0} = ($bf[5], $bf[5], $bf[5], $bf[5]);
...
our %defines = (
    ...
    OPpTARGET_MY             =>  16,
    OPpTRANS_BITS            =>   2,
    OPpTRANS_CAN_FORCE_UTF8  =>   2,
    OPpTRANS_COMPLEMENT      =>  32,
    OPpTRANS_DELETE          => 128,
    OPpTRANS_GROWS           =>   3,
    OPpTRANS_IDENTICAL       =>   4,
    OPpTRANS_MASK            =>   3,
    OPpTRANS_ONLY_UTF8_INVARIANTS  =>   1,
    OPpTRANS_SHIFT           =>   0,
    OPpTRANS_SQUASH          =>   8,
    OPpTRANS_USE_SVOP        =>  64,
    OPpTRUEBOOL              =>  32,
    OPpUNDEF_KEEP_PV         =>  32,
    OPpUSEINT                =>   4,
    SVrt_ARRAY               =>   1,
...
our %labels = (
    ...
    OPpCALLER_BITS           => 'BITS',
    OPpCALLER_FILE           => 'FILE',
    OPpCALLER_HINTH          => 'HINTH',
    OPpCALLER_HINTS          => 'HINTS',
    OPpCALLER_LINE           => 'LINE',
    OPpCALLER_PKG            => 'PKG',
    OPpCALLER_SUB            => 'SUB',
    ...
    OPpLVREF_ITER            => 'ITER',
    OPpLVREF_SV              => 'SV',
    OPpMATCH_JUST_COUNT      => 'JUST_COUNT',
    ...
    OPpTRANS_ONLY_UTF8_INVARIANTS  => 'ONLY_UTF8_INVARIANTS',
...
our %ops_using = (
    ...
    OPpSTATEMENT             => [qw(and cond_expr or)],
...
$ops_using{OPpCALLER_FILE} = $ops_using{OPpCALLER_BITS};
$ops_using{OPpCALLER_HINTH} = $ops_using{OPpCALLER_BITS};
$ops_using{OPpCALLER_HINTS} = $ops_using{OPpCALLER_BITS};
$ops_using{OPpCALLER_LINE} = $ops_using{OPpCALLER_BITS};
$ops_using{OPpCALLER_PKG} = $ops_using{OPpCALLER_BITS};
$ops_using{OPpCALLER_SUB} = $ops_using{OPpCALLER_BITS};
...
$ops_using{OPpITER_REFALIAS} = $ops_using{OPpITER_INDEXED};
...
$ops_using{OPpREF_CMP_L2R} = $ops_using{OPpREF_CMP_AND};
...
$ops_using{OPpTRANS_USE_SVOP} = $ops_using{OPpTRANS_COMPLEMENT};
