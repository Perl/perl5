 ...
 * appear here.
locales
 * addmntent()         getlogin_r()          iswgraph()          strcoll()
 * alphasort()         getmntent()           iswgraph_l()        strfmon()
 * asctime()           getmntent_r()         iswlower()          strfromd()
 * asctime_r()         getnameinfo()         iswlower_l()        strfromf()
 * asprintf()          getnetbyaddr()        iswprint()          strfroml()
 * atof()              getnetbyaddr_r()      iswprint_l()        strftime()
 * atoi()              getnetbyname()        iswpunct()          strncasecmp()
 * atol()              getnetbyname_r()      iswpunct_l()        strptime()
 * atoll()             getnetent()           iswspace()          strsignal()
 * ctime()             getnetent_r()         iswspace_l()        strtod()
 * ctime_r()           getnetgrent()         iswupper()          strtof()
 * cuserid()           getnetgrent_r()       iswupper_l()        strtoimax()
 * dirname()           getprotobyname()      iswxdigit()         strtol()
 * dprintf()           getprotobyname_r()    iswxdigit_l()       strtold()
 * endaliasent()       getprotobynumber()    localeconv()        strtoll()
 * endgrent()          getprotobynumber_r()  localtime()         strtoq()
 * endgrent_r()        getprotoent()         localtime_r()       strtoul()
 * endhostent()        getprotoent_r()       mktime()            strtoull()
 * endhostent_r()      getpw()               nan()               strtoumax()
 * endnetent()         getpwent()            nanf()              strtouq()
 * endnetent_r()       getpwent_r()          nanl()              strxfrm()
 * endprotoent()       getpwnam()            nl_langinfo()       swprintf()
 * endprotoent_r()     getpwnam_r()          openpty()           swscanf()
 * endpwent()          getpwuid()            printf()            syslog()
 * endpwent_r()        getpwuid_r()          psiginfo()          timegm()
 * endrpcent()         getrpcbyname_r()      psignal()           timelocal()
 * endservent()        getrpcbynumber_r()    putpwent()          tzset()
 * endservent_r()      getrpcent_r()         putspent()          vasprintf()
 * endspent()          getrpcport()          regcomp()           vdprintf()
 * err()               getservbyname()       regexec()           verr()
 * error()             getservbyname_r()     res_nclose()        verrx()
 * error_at_line()     getservbyport()       res_ninit()         versionsort()
 * errx()              getservbyport_r()     res_nquery()        vfprintf()
 * fnmatch()           getservent()          res_nquerydomain()  vfscanf()
 * forkpty()           getservent_r()        res_nsearch()       vfwprintf()
 * fprintf()           getspent()            res_nsend()         vprintf()
 * fscanf()            getspent_r()          rpmatch()           vscanf()
 * fwprintf()          getspnam()            ruserok()           vsnprintf()
 * fwscanf()           getspnam_r()          ruserok_af()        vsprintf()
 * getaddrinfo()       glob()                scanf()             vsscanf()
 * getaliasbyname_r()  gmtime()              setaliasent()       vswprintf()
 * getaliasent_r()     gmtime_r()            setgrent()          vsyslog()
 * getdate()           grantpt()             setgrent_r()        vwarn()
 * getdate_r()         iconv_open()          sethostent()        vwarnx()
 * getfsent()          inet_addr()           sethostent_r()      vwprintf()
 * getfsfile()         inet_aton()           setnetent()         warn()
 * getfsspec()         inet_network()        setnetent_r()       warnx()
 * getgrent()          inet_ntoa()           setnetgrent()       wcscasecmp()
 * getgrent_r()        inet_ntop()           setprotoent()       wcscoll()
 * getgrgid()          inet_pton()           setprotoent_r()     wcsncasecmp()
 * getgrgid_r()        initgroups()          setpwent()          wcstod()
 * getgrnam()          innetgr()             setpwent_r()        wcstof()
 * getgrnam_r()        iruserok()            setrpcent()         wcstoimax()
 * getgrouplist()      iruserok_af()         setservent()        wcstold()
 * gethostbyaddr()     iswalnum()            setservent_r()      wcstoumax()
 * gethostbyaddr_r()   iswalnum_l()          setspent()          wcswidth()
 * gethostbyname()     iswalpha()            sgetspent_r()       wcsxfrm()
 * gethostbyname2()    iswalpha_l()          shm_open()          wctrans()
 * gethostbyname2_r()  iswblank()            shm_unlink()        wctype()
 * gethostbyname_r()   iswblank_l()          snprintf()          wcwidth()
 * gethostent()        iswcntrl()            sprintf()           wordexp()
 * gethostent_r()      iswcntrl_l()          sscanf()            wprintf()
 * gethostid()         iswdigit()            strcasecmp()        wscanf()
 * getlogin()          iswdigit_l()          strcasestr()        
###
envs
