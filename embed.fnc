...
XEpR	|SSize_t|utf8_validate_and_fix|NN const U8 **start|NN const U8 *send|NULLOK U8 **out|NULLOK U8 *oend|const U32 flags|bool eof|NN U32 *unfixed_errors|NN AV **msgs
